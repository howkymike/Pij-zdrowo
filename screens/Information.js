...
export default function Information({ navigation }) {
  ...
  React.useEffect(() => {
    async function GetData(source, token) {
      ...
      const options = {
        method: "GET",
        headers: { Auth: token },
        url: `${authCtx.URL}/lastData?count=1`, //data/id/`+source,
      };
      try {
  ...
  const { container, LoginText, InformationText, Bullet, ViewText } = styles;
        ...
        <View style={container}>
          ...
          <View style={ViewText}>
            ...
            <Text style={InformationText}>
              Ph wody w normie. TDS w normie. Woda zdatna do picia
            </Text>
          </View>
        </View>
      );
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Ph wody w normie. TDS w granicach normy. Woda zdatna do picia.
              Warto monitorować
            </Text>
          </View>
        </View>
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Ph wody w normie, ale woda zbyt twarda
            </Text>
          </View>
        </View>
      );
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Woda ma odczyn kwasowy.TDS w normie. Woda nie zdatna do picia
            </Text>
          </View>
        </View>
      );
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Woda ma odczyn kwasowy. TDS w granicach normy.Woda nie zdatna do
              picia
            </Text>
          </View>
        </View>
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Woda ma odczyn kwasowy i jest zbyt twarda. Woda nie zdatna do
              picia
            </Text>
          </View>
        </View>
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Woda ma odczyn zasadowy.TDS w normie. Woda nie zdatna do picia
            </Text>
          </View>
        </View>
      );
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Woda ma odczyn zasadowy. TDS w granicach normy.Woda nie zdatna do
              picia
            </Text>
          </View>
        </View>
      ...
      return (
        <View style={container}>
          ...
          <View style={ViewText}>
            <Text style={Bullet}>{"\u25CF"}</Text>
            <Text style={InformationText}>
              Woda ma odczyn zasadowy i jest zbyt twarda. Woda nie zdatna do
              picia
            </Text>
          </View>
        </View>
